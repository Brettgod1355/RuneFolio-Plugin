...
Third-party code and dependencies retain their own licenses and notices; see [third-party notices](THIRD_PARTY_NOTICES.md). Preserve those notices too when redistributing the corresponding material.

This source-code license does not grant rights to third-party artwork, game content, trademarks or user-submitted material. It does not transfer anyone's ownership or imply endorsement by RuneFolio, RuneLite or Jagex. Existing file-specific copyright notices remain intact.
