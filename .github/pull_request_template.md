...
- [ ] State whether this change copies/adapts third-party material or uses only existing APIs/original code.
- [ ] For reused material, verify exact-source licensing and record source/revision, modifications and credits in THIRD_PARTY_NOTICES.md.
- [ ] Preserve required notices in source and distributed output; run verifyDistributionNotices.
